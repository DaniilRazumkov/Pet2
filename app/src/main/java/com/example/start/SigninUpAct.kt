...
import com.example.start.databinding.ActivitySigninUpBinding
...
class SigninUpAct : AppCompatActivity() {
    ...
    fun onCLickDone(view: View) {
        if (signState == Constance.SIGN_UP_STATE) {
           ...
           if (bindingClass.imAvatar.isVisible) intent.putExtra(Constance.AVATAR_ID,R.drawable.director)
