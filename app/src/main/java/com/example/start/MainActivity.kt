...
class MainActivity : AppCompatActivity() {
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if (requestCode == Constance.REGUEST_CODE_SIGN_IN) {
            ...
            if (login == l && password == p) {
                ...
                bindingClass.tvInfo.text = "Такого акаунта не существует!"
            }

        } else if (requestCode == Constance.REGUEST_CODE_SIGN_UP) {
    ...
    fun onClickSignIn(view: View) {
        if (bindingClass.imAvatar.isVisible && bindingClass.tvInfo.text.toString() !="Такого акаунта не существует!") {
            ...
            startActivityForResult(intent, Constance.REGUEST_CODE_SIGN_IN)
        }
    ...
    fun onClickSignUp(view: View) {
        ...
        startActivityForResult(intent, Constance.REGUEST_CODE_SIGN_UP)
